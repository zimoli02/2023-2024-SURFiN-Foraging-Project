...
def main():
    ...
    for session, j in zip(list(long_sessions.itertuples()), range(len(long_sessions))):
        if j < 5:
            ...
            np.save(title+"Transition_3.npy", transition_mat[index].T[index].T)
            ...
            np.save(title+"States_3.npy", states)
            ...
            for i in range(N):
                ...
                axs[i].set_xlabel('X')
                axs[i].set_ylabel('Y')
            plt.savefig('/nfs/nhome/live/zimol/ProjectAeon/aeon_mecha/images/HMM/'+title+'Position_3.png')
            ...
            plt.savefig('/nfs/nhome/live/zimol/ProjectAeon/aeon_mecha/images/HMM/'+title+'Data_3.png')
