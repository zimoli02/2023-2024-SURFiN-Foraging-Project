...
def main():
    ...
    for session, j in zip(list(long_sessions.itertuples()), range(len(long_sessions))):
        if j == 1:
            ...
            np.save(title+"Transition_1.npy", transition_mat[index].T[index].T)
            ...
            np.save(title+"States_1.npy", states)
            ...
            for i in range(N):
                ...
                axs[i].set_xlabel('X')
                axs[i].set_ylabel('Y')
            plt.savefig('/nfs/nhome/live/zimol/ProjectAeon/aeon_mecha/images/HMM/'+title+'Position_1.png')
            ...
            for data, i in zip(DATA, range(len(DATA))):
                ...
                axs[i].set_xticks(range(0, N), ['0', '1', '2', '3','4'])
                axs[i].set_ylabel(FEATURE[i])
            plt.savefig('/nfs/nhome/live/zimol/ProjectAeon/aeon_mecha/images/HMM/'+title+'Data_1.png')
